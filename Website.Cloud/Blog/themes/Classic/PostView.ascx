...
<div class="post xfolkentry" id="post<%=Index %>">
  ...
  <span class="author">by <a href="<%=BlogEngine.Core.Utils.RelativeWebRoot + "author/" + BlogEngine.Core.Utils.RemoveIllegalCharacters(Post.Author) + BlogEngine.Core.BlogConfig.FileExtension %>"><%=Post.AuthorProfile != null ? Post.AuthorProfile.DisplayName : Post.Author %></a></span>
