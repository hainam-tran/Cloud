...
<div class="post xfolkentry" id="post<%=Index %>">
    ...
    <div class="postfooter">
        ...
        <a rel="nofollow" href="<%=Post.RelativeOrAbsoluteLink %>#comment">
         ...
         |   
        <a rel="nofollow" href="<%=CommentFeed %>"><asp:Image ID="Image1" runat="Server" ImageUrl="~/Blog/pics/rssButton.png" AlternateText="RSS comment feed" style="margin-right:3px" />Comment RSS</a>
    </div>
    <br />
</div>