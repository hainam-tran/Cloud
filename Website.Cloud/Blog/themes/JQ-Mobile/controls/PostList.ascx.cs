namespace MichaelJBaird.Themes.JQMobile.Controls
{
  ...
  public partial class PostList : System.Web.UI.UserControl
  {
    ...
    private void BindPosts()
    {
      ...
      var path = string.Format("/Blog/themes/{1}/PostView.ascx", Utils.ApplicationRelativeWebRoot, BlogSettings.Instance.GetThemeWithAdjustments(this.Request.QueryString["theme"]));
      var counter = 0;
